    ...
    <>
      <div className="px-4 py-2 relative">
        ...
        <div className="md:flex justify-center sm:justify-end my-2 gap-2">
          ...
          <Button
            variant="outline"
            className={`text-[0.8rem] text-white  hover:bg-[#fff] hover:text-[#29354f] hover:border-[#004d4b] ${
              isShow ? "bg-[#145f64] opacity-55" : "bg-[#0f464a]"
            }`}
            onClick={showTable}
          >
            Visit Logs
          ...
          <div className="flex justify-normal lg:justify-end">
            <Link href={"/employeeLeaveManagement/addEmployeeLeave"}>
              <Button
                variant="outline"
                className=" text-[0.8rem] text-white bg-[#0f464a] hover:bg-[#fff] hover:text-[#29354f] hover:border-[#004d4b]"
              >
                New Leave
              </Button>
            </Link>
