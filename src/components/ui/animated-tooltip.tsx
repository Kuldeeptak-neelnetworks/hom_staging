...
export const AnimatedTooltip: React.FC<AnimatedTooltipProps> = ({ item }) => {
        ...
        <AnimatePresence mode="popLayout">
          {hoveredIndex === item.id && (
            <motion.div
              ...
              className="absolute -top-16 first:-top-10 left-1/2 z-50 flex -translate-x-1/2 flex-col items-center justify-center rounded-md bg-black px-4 py-2 text-xs shadow-xl"
            >
