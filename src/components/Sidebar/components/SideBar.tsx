...
const menuItems = [
  {
    href: "/inbox",
    icon: <NotificationBellIconSVG cssClass={"sidebar-icon-svg"} />,
    label: "Inbox",
  },
  {
    href: "/dashboard",
      ...
      >
        ...
        <div
          className={`logo_wrapper flex items-center h-12 border-b border-gray-500 ${
            isCollapsed ? "mt-[0.6rem] pb-3 px-1" : "px-2"
          }`}
        >
          <div className="cursor-pointer">
            <Link href="/dashboard">
              <img src={isCollapsed ? MiniLogoSrc : logoSrc} alt="Logo" />
            </Link>
          </div>
          {/* <div
            className={`${
          ...
          <div className="flex justify-end">
            ...
            <button
              className={`${
                isCollapsed ? "ml-2 p-1" : "ml-[0.8rem] p-2"
              } cursor-pointer bg-[#4b9437] hover:bg-gray-400 text-white mb-2 focus:outline-none text-[0.8rem]`}
