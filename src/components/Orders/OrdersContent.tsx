...
const OrdersContent = () => {
  ...
  const debouncedSearch = useCallback(
    ...
    [fetchAllOrdersData, filters, page, limit, orderYear]
  );
  ...
  }, [page, limit, searchInput, filters, fetchAllOrdersData, orderYear]);

  useEffect(() => {
    if (searchInput !== "") {
      debouncedSearch(searchInput);
    } else {
      fetchAllOrdersData({ page, limit, searchInput, filters, orderYear });
    }
  ...
  return (
    <div className="px-4 py-2 relative ">
      ...
      <div className="w-[300px] md:w-[500px] lg:absolute z-[50] md:flex gap-2">
        <Select
