...
const InvoiceDialoge = ({ id, Invoice }: any) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger>
        <FileTextIcon className="h-[1.55rem] w-[1.75rem] p-1 hover:bg-[#004d4b] text-black hover:text-[white] " />
      </DialogTrigger>
      ...
      <DialogContent className="sm:max-w-[1000px] ">
        ...
        {Invoice?.startsWith("https://high-oaks-media-team.monday.com") ? (
          <>
            <p className="bg-[#004d4b] text-white p-5 flex justify-center text-lg ">
